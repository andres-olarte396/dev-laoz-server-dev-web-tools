...
- [ ] [**1. QRcoder**](https://github.com/andres-olarte396/dev-laoz-QRcoder)  
  _Generador de códigos QR para aplicaciones web o móviles._
- [ ] [**2. HashGenerator**](https://github.com/andres-olarte396/dev-laoz-HashGenerator)  
  _Herramienta para generar y validar hashes criptográficos._
- [ ] [**3. IconSelector**](https://github.com/andres-olarte396/dev-laoz-IconSelector)  
  _Librería para seleccionar y gestionar iconos personalizados._
- [ ] [**4. URIComponent**](https://github.com/andres-olarte396/dev-laoz-URIComponent)  
  _Utilidad para codificar y decodificar componentes de URLs._
- [ ] [**5. ConversorHEX-RGB**](https://github.com/andres-olarte396/dev-laoz-ConversorHEX-RGB)
...
- [ ] [**6. Slug Generator**](https://github.com/andres-olarte396/dev-laoz-SlugGenerator)
  _Utilidad simple que convierte texto en slugs (URLs amigables). Es útil para generar rutas limpias y comprensibles._
- [ ] [**7. Password Generator**](https://github.com/andres-olarte396/dev-laoz-PassGenerator)
...
- [ ] [**8. JWT Decoder**](https://github.com/andres-olarte396/dev-laoz-JWTDecoder)
...
- [ ] [**16. Minificador JS CSS**](https://github.com/andres-olarte396/dev-laoz-Minificador-JS-CSS)
...
- [ ] [**17. XML JSON Validator**](https://github.com/andres-olarte396/dev-laoz-XML-JSON-Validator)
...
- [ ] [**18. Currency Conversor**](https://github.com/andres-olarte396/dev-laoz-CurrencyConversor)
...
- [ ] [**19. Emoji Search**](https://github.com/andres-olarte396/dev-laoz-EmojiSearch)
...
- [ ] [**20. Unit Conversor**](https://github.com/andres-olarte396/dev-laoz-UnitConversor)
...
- [ ] [**21. Table to JSON**](https://github.com/andres-olarte396/dev-laoz-table-to-json)
...
- [ ] [**22. Data Calculator**](https://github.com/andres-olarte396/dev-laoz-DataCalculator)
  _Este proyecto es una página web simple que permite realizar las operaciones relacionadas con datos y velocidad._
- [ ] [**23. HTML Project Base**](https://github.com/andres-olarte396/dev-laoz-HTML-Project-Base)
...
- [ ] [**27. Markdown viwer**](https://github.com/andres-olarte396/dev-laoz-markdown-viwer)
...
- [ ] [**28. Markdown project**](https://github.com/andres-olarte396/dev-laoz-markdown-project)
...
- **17 de diciembre de 2024:** Documento inicial creado y configurado.
- **20 de diciembre de 2024:** Añadidos nuevos repositorios y herramientas de instalación.
- **25 de diciembre de 2024:** Actualización de estado de instalaciones y eliminación de repositorios obsoletos.
- **30 de diciembre de 2024:** Revisión completa del documento y ajustes en las descripciones.

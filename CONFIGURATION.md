...
- [x] [**1. JWT Decoder**](https://github.com/andres-olarte396/dev-laoz-JWTDecoder)
...
- [x] [**9. Minificador JS CSS**](https://github.com/andres-olarte396/dev-laoz-Minificador-JS-CSS)
...
- [x] [**10. XML JSON Validator**](https://github.com/andres-olarte396/dev-laoz-XML-JSON-Validator)
...
- [x] [**11. Emoji Search**](https://github.com/andres-olarte396/dev-laoz-EmojiSearch)
...
- [x] [**12. Unit Conversor**](https://github.com/andres-olarte396/dev-laoz-UnitConversor)
...
- [x] [**13. Table to JSON**](https://github.com/andres-olarte396/dev-laoz-table-to-json)
...
- [x] [**14. HTML Project Base**](https://github.com/andres-olarte396/dev-laoz-HTML-Project-Base)
...
- [x] [**15. Wave Art CSS**](https://github.com/andres-olarte396/dev-laoz-WaveArtCSS)
...
- [x] [**16. Image viwer**](https://github.com/andres-olarte396/dev-laoz-image-viwer)
...
- [x] [**17. Network latency-simulator**](https://github.com/andres-olarte396/dev-laoz-network-latency-simulator)
  _Herramienta poderosa que te permite simular diversas condiciones de red, como velocidad, latencia y pérdida de paquetes._

- [x] [**18. Markdown viwer**](https://github.com/andres-olarte396/dev-laoz-markdown-viwer)
...
- [x] [**19. Markdown project**](https://github.com/andres-olarte396/dev-laoz-markdown-project)
  _Este proyecto genera un menú dinámico basado en archivos Markdown (.md) contenidos en un directorio._

- [x] [**20. API Gateway**](https://github.com/andres-olarte396/dev-laoz-api-gateway)
...
- [x] [**21. API Autenticación**](https://github.com/andres-olarte396/dev-laoz-authentication-api)
...
- [x] [**22. API Autorización**](https://github.com/andres-olarte396/dev-laoz-authorization-api)
...
- [x] [**23. API Usuarios**](https://github.com/andres-olarte396/dev-laoz-api-user)
